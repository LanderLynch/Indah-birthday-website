...
(function (window, document) {
  ...
  const PLATE_GRADIENTS = [
    'linear-gradient(155deg, rgba(42,212,212,0.22), rgba(8,36,58,0.92))',
    'linear-gradient(155deg, rgba(255,215,106,0.16), rgba(7,28,46,0.94))',
    'linear-gradient(155deg, rgba(124,232,240,0.18), rgba(6,24,42,0.92))',
    'linear-gradient(155deg, rgba(255,138,122,0.12), rgba(6,22,38,0.94))',
    'linear-gradient(155deg, rgba(42,212,212,0.14), rgba(255,215,106,0.07), rgba(5,20,34,0.94))',
    'linear-gradient(155deg, rgba(124,232,240,0.1), rgba(4,14,26,0.95))'
  ];
